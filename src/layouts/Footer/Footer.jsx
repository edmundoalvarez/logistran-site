...
const Footer = () => {
    ...
    return (
      <footer className="bg-graylighter text-darkblue">
        <ul className='
        ...
        '>
          ...
          <li className='flex flex-col align-top justify-center gap-2 text-center w-full border-t border-graydarker pt-8'>
