    ...
    <>
      ...
      `}>
        <div className={styles.image}>
          <picture>
            <source srcSet="./images/intro-xlbig.jpg" media="(min-width: 1400px)" />
            <source srcSet="./images/intro-xbig.jpg" media="(min-width: 1280px) and (max-width:1399px)" />
            <source srcSet="./images/intro-big.jpg" media="(min-width: 1024px) and (max-width: 1279px)" />
            <source srcSet="./images/intro-medium.jpg" media="(min-width: 768px) and (max-width: 1023px)" />
